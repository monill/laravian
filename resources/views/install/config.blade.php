                ...
                <div class="installation-wrapper">
                    <div class="install-content-area">
                        <div class="install-item">
                            ...
                            <div class="box-item">
                                <form action="{{ route('install.configSave') }}" method="post" class="information-form-area mb--20">
                                    @csrf
                                    <div class="info-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="information-form-group col-sm-6">
                                                ...
                                                <input type="text" name="server_url" id="server_url" value="{{ url('/') }}" required>
                                            </div>
                                            <div class="information-form-group col-sm-6">
                                                <label for="storagemultiplier">Storage Multiplier:</label>
                                                <input type="text" name="storagemultiplier" id="storagemultiplier" value="2" required>
                                            </div>
                                            <div class="information-form-group col-sm-6">
                                            ...
                                            <div class="information-form-group col-sm-6">
                                                <label for="maxprotecttime">Max Beginners Protection:</label>
                                                <select class="form-control" name="maxprotecttime" id="maxprotecttime">
                                            ...
                                            <div class="information-form-group col-sm-6">
                                                <label for="newsbox1">News Box 1:</label>
                                                <select class="form-control" name="newsbox1" id="newsbox1">
                                                    <option value="1">Enable</option>
                                                    <option value="0" selected="selected">Disable</option>
                                                </select>
                                            </div>
                                            <div class="information-form-group col-sm-6">
                                                <label for="newsbox2">News Box 2:</label>
                                                <select class="form-control" name="newsbox2" id="newsbox2">
                                                    <option value="1">Enable</option>
                                                    <option value="0" selected="selected">Disable</option>
                                                </select>
                                            </div>
                                            <div class="information-form-group col-sm-6">
                                                <label for="newsbox3">News Box 3:</label>
                                                <select class="form-control" name="newsbox3" id="newsbox3">
                                                    <option value="1">Enable</option>
                                                    <option value="0" selected="selected">Disable</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="lastgavemedal">last gave medal:</label>
                                                <input type="number" name="lastgavemedal" id="lastgavemedal" value="null">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="winmoment">winmoment:</label>
                                                <input type="number" name="winmoment" id="winmoment" value="0">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="stats_lasttime">stats_lasttime:</label>
                                                <input type="number" name="stats_lasttime" id="stats_lasttime" value="{{ time() }}">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="minimap_time">minimap_time:</label>
                                                <input type="number" name="minimap_time" id="minimap_time" value="{{ time() }}">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="last_checkall">last_checkall:</label>
                                                <input type="number" name="last_checkall" id="last_checkall" value="{{ time() }}">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="freegold_lasttime">last_checkall:</label>
                                                <input type="number" name="freegold_lasttime" id="freegold_lasttime" value="{{ time() }}">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="checkall_time">last_checkall:</label>
                                                <input type="number" name="checkall_time" id="checkall_time" value="3600">
                                            </div>
                                            <div class="information-form-group col-sm-6" id="hide">
                                                <label for="commence">last_checkall:</label>
                                                <input type="number" name="commence" id="commence" value="{{ time() }}">
                                            </div>
                                            ...
                                            <div class="information-form-group col-sm-6">
                                                <label for="stats_time">Stats Time:</label>
                                                <input type="number" name="stats_time" id="stats_time" value="21600" required>
                                            </div>
                                            <div class="information-form-group col-sm-6">
                                                <label for="taskmaster">Quests:</label>
                                                <select class="form-control" name="taskmaster" id="taskmaster">
                                                    <option value="0">Disable</option>
                                                    <option value="1" selected="selected">Enable</option>
                                                </select>
                                            </div>
                                            <div class="information-form-group col-sm-6">
                                                <label for="auth_email">Activation Email:</label>
                                                <select class="form-control" name="auth_email" id="auth_email">
                                                    <option value="0" selected="selected">Disable</option>
                                                    <option value="1">Enable</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="information-form-group col-sm-6">
                                                <label for="demolish_lvl">Level Required of Main building for Demolishng Other Building</label>
                                                <select class="form-control" name="demolish_lvl" id="demolish_lvl">
