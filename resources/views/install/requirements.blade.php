                        ...
                        <div class="install-item">
                            ...
                            <div class="box-item">
                                ...
                                <div class="item text-right">
                                    @if ($error == 0)
                                        <a class="theme-button choto" href="{{ route('install.permissions') }}">Next Step <i class="fa fa-angle-double-right"></i></a>
                                    @else
                                        <a class="theme-button btn-warning choto" href="{{ route('install.requirements') }}">Re-Check <i class="fa fa-sync-alt"></i></a>
                                    @endif
                                </div>
                            </div>
                        </div>
