                ...
                <div class="installation-wrapper">
                    <div class="install-content-area">
                        <div class="install-item">
                            <h3 class="bg-warning title text-center">Multihunter</h3>
                            <div class="box-item">
                                <form action="{{ route('install.multihunterSave') }}" method="post" class="information-form-area mb--20">
                                    @csrf
                                    <div class="info-item">
                                        <h5 class="font-weight-normal mb-2">Multihunter Details</h5>
                                        <div class="row">
                                            <div class="information-form-group col-sm-6">
                                                <label for="mhpwd">Multihunter Password</label>
                                                <input type="text" name="mhpwd" id="mhpwd" value="123456789" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <div class="information-form-group text-right">
                                            <button type="submit" class="theme-button choto">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
