                ...
                <div class="installation-wrapper">
                    <div class="install-content-area">
                        <div class="install-item">
                            <h3 class="bg-warning title text-center">Populate Oasis</h3>
                            <div class="box-item">
                                <form action="{{ route('install.oasisSave') }}" method="post" class="information-form-area mb--20">
                                    @csrf
                                    <div class="info-item">
                                        <h5 class="font-weight-normal mb-2 text-center">Oasis Details!</h5>
                                    ...
                                    <div class="info-item">
                                        <div class="information-form-group text-right">
                                            <button type="submit" class="theme-button choto">Create</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
