                ...
                <div class="installation-wrapper">
                    <div class="install-content-area">
                        <div class="install-item">
                            <h3 class="bg-warning title text-center">Create World Data</h3>
                            <div class="box-item">
                                <form action="{{ route('install.worldSave') }}" method="post" class="information-form-area mb--20">
                                    @csrf
                                    <div class="info-item">
                                        <h5 class="font-weight-normal mb-2 text-center">Warning!</h5>
                                        <span class="text-warning"><i class="fas fa-exclamation-triangle"></i>
                                            This can take some time. Do not click, just wait till the next page has been loaded!
                                        </span>
                                    </div>
                                    <div class="info-item">
                                        <div class="information-form-group text-right">
                                            <button type="submit" class="theme-button choto">Create World</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
