...
<div id="content" class="map">
    ...
    <div class="map2">
        <div id="mapContainer">
                            ...
                            <div class="contents">
                                <div class="coordinatesInput">
                                    <div class="xCoord">
                                        ...
                                        <input maxlength="4" value="<?php echo $coorproc['x']; ?>" name="x"
                                               id="xCoordInputMap" class="text coordinates x "/>
                                    </div>
                                    <div class="yCoord">
                                        <label for="yCoordInputMap">Y:</label>
                                        <input maxlength="4" value="<?php echo $coorproc['y']; ?>" name="y"
                                               id="yCoordInputMap" class="text coordinates y "/>
                                    </div>
                                    <div class="clear"></div>
                                </div>
            ...
            <div id="minimapContainer">
                ...
                <div id="miniMap"><img class="map" style="width: 185px; height: 109px;" src="minimap.php"
                                       alt="MiniMap"/></div>
                <div class="bl">
                    <div class="br">
                        <div class="bc"></div>
    ...
    <script type="text/javascript">
        Travian.Translation.add({
            ...
            'b:ri1': '&lt;img src="..//images/x.gif" class="iReport iReport1"/&gt;'.unescapeHtml(),
            'b:ri2': '&lt;img src="..//images/x.gif" class="iReport iReport2"/&gt;'.unescapeHtml(),
            'b:ri3': '&lt;img src="..//images/x.gif" class="iReport iReport3"/&gt;'.unescapeHtml(),
            'b:ri4': '&lt;img src="..//images/x.gif" class="iReport iReport4"/&gt;'.unescapeHtml(),
            'b:ri5': '&lt;img src="..//images/x.gif" class="iReport iReport5"/&gt;'.unescapeHtml(),
            'b:ri6': '&lt;img src="..//images/x.gif" class="iReport iReport6"/&gt;'.unescapeHtml(),
            'b:ri7': '&lt;img src="..//images/x.gif" class="iReport iReport7"/&gt;'.unescapeHtml(),

            'b:bi0': '&lt;img class="carry empty" src="..//images/x.gif" alt="Bounty" /&gt;'.unescapeHtml(),
            'b:bi1': '&lt;img class="carry half" src="..//images/x.gif" alt="Bounty" /&gt;'.unescapeHtml(),
            'b:bi2': '&lt;img class="carry" src="..//images/x.gif" alt="Bounty" /&gt;'.unescapeHtml(),
            ...
            'a:r1': '&lt;img alt="Lumber" src="..//images/x.gif" class="r1"&gt;'.unescapeHtml(),
            'a:r2': '&lt;img alt="Clay" src="..//images/x.gif" class="r2"&gt;'.unescapeHtml(),
            'a:r3': '&lt;img alt="Iron" src="..//images/x.gif" class="r3"&gt;'.unescapeHtml(),
            'a:r4': '&lt;img alt="Crop" src="..//images/x.gif" class="r4"&gt;'.unescapeHtml(),
