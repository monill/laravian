<div id="header">
    ...
    <div id="goldSilver">
        <div class="gold">
            <img class="gold" src="{{ Vite::asset('resources/images/x.gif') }}" alt="Gold">
            <span class="ajaxReplaceableGoldAmount">{{ auth()->user()->gold }}</span>
        </div>
        <div class="silver">
            <a class="silver" href="hero/auction">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Siler">
            </a>
            <span class="ajaxReplaceableSilverAmount">{{ auth()->user()->silver }}</span>
        </div>
    </div>
    <ul id="outOfGame">
        <li class="profile">
            <a href="spieler?uid=$session->uid">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Profile" />
            </a>
        </li>
        <li class="options">
            <a href="options" title="Settings">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Settings" />
            </a>
        </li>
        <li class="forum">
            <a href="#" title="Forum">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Forum" />
            </a>
        </li>
        <li class="chat">
            <a href="#" title="Chat">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Chat" />
            </a>
        </li>
        <li class="help">
            <a href="help" title="Help">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Help" />
            </a>
        </li>
        <li class="logout">
            <a href="logout" title="Logout">
                <img src="{{ Vite::asset('resources/images/x.gif') }}" alt="Logout" />
            </a>
        </li>
        <li class="clear"></li>
    </ul>
