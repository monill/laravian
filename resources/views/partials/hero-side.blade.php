<div id="sidebarBoxHero" class="sidebarBox toggleable expanded">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            ...
            ?>
            <button id="heroImageButton" onclick="window.location.href='hero/inventory';" class="heroImageButton " type="button" title="<?php echo HS_HEROOVER . $statusInfoText; ?>">
                <img src="hero/image?uid=<?php echo $session->uid; ?>&size=sideinfo&<?php echo $hero['hash']; ?>" class="heroImage" />
            </button>
