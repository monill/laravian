...
<head>
    ...
    <title>Setup Tribe and Village</title>
    <!-- Scripts -->
...
<div class="container">
    <form id="character-form" action="{{ route('activate') }}" method="POST">
        @csrf
            ...
            <div class="tribe-container">
                <div class="column">
                    <div class="character" id="teutons" data-tribe="teutons">
                        ...
                        <img src="{{ Vite::asset('resources/images/activate/teutons.png') }}" alt="Teutons">
                ...
                <div class="column">
                    <div class="character" id="gauls" data-tribe="gauls">
                        ...
                        <img src="{{ Vite::asset('resources/images/activate/gauls.png') }}" alt="Gauls">
                        <div class="description">
                            <p class="properties">Properties:</p>
                            <ul>
                ...
                <div class="column">
                    <div class="character" id="romans" data-tribe="romans">
                        ...
                        <img src="{{ Vite::asset('resources/images/activate/romans.png') }}" alt="Romans">
                        <div class="description">
                            <p class="properties">Properties:</p>
                            <ul>
